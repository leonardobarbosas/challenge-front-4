    ...
    <main className="flex h-screen w-full justify-center">
      <div className="flex w-full ">
        <div className="flex items-center justify-center w-1/2">
          <form className="flex flex-col text-black items-center justify-around w-4/5 h-[800px] bg-[#40a9e4] rounded-[15px] shadow-[rgba(0,0,0,0.25)_0px_54px_55px,rgba(0,0,0,0.12)_0px_-12px_30px,rgba(0,0,0,0.12)_0px_4px_6px,rgba(0,0,0,0.17)_0px_12px_13px,rgba(0,0,0,0.09)_0px_-3px_5px]">
